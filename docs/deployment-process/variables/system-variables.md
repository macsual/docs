...
|**`Octopus.Deployment.Trigger.Id`** <br/>The ID of the [project trigger](/docs/deployment-process/project-triggers/index.md) which caused the deployment. If the deployment was not caused by a trigger (or pre 2019.5.0) this variable will not be present. | *ProjectTriggers-2*|
|**`Octopus.Deployment.Trigger.Name`** <br/>The name of the [project trigger](/docs/deployment-process/project-triggers/index.md) which caused the deployment. If the deployment was not caused by a trigger (or pre 2019.5.0) this variable will not be present. | *Deploy every day*|
